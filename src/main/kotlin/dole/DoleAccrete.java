...
public class DoleAccrete {
   ...
   */
  private LinkedList<DustRecord> list0 = new LinkedList<>();

  /**
   * Linked list of gas records
   */
  private LinkedList<DustRecord> list1 = new LinkedList<>();

  /**
   * Linked list of dust records
   */
  private LinkedList<DustRecord> list2 = new LinkedList<>();

  /**
   * Critical mass for gas accretion
   */
  private double criticalMass; /* for accreting gas */
   ...
   */
  private double getDensity(double r) {
    return (A * Math.exp(
   ...
   */
  private double getReach(double radius, double mass) {
   ...
   */
  private void addPlanet(List<Planet> list, Planet newp) {
    list.add(newp);
    list.sort(comparing(Planet::getA));
  }
   ...
   */
  private DolePlanetRecord createPlanet(Primary star) {
   ...
   */
  private void updateBands(LinkedList<DustRecord> list, DolePlanetRecord p) {
   ...
   * @param p    The planet being constructed
   */
  private void evolvePlanet(Primary star, DolePlanetRecord p) {
    double perihelion;
    double aphelion;
    double previousMass;
    double swept;
   ...
   */
  private void checkCoalesence(Primary star, DolePlanetRecord p) {
    boolean merged = true;
